...
E100=EvaluateMetrics(final_model='RMmodel100.pkl',modelName='tierT12_10_100')
E100.confusionMatrixTrain()
E100.confusionMatrix()
E100.rocValidate()
E100.prValidate() 

E100_all=combinedEvaluations(final_model_name='RMmodel100.pkl',modelName='tierT12_10_100')
...
E50_all=combinedEvaluations(final_model_name='RMmodel50.pkl',modelName='tierT12_10_50',control=False)
