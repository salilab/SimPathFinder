...
from sklearn.metrics import fbeta_score,f1_score,hamming_loss,accuracy_score,recall_score,confusion_matrix,f1_score,precision_score,log_loss,classification_report,mean_squared_error,make_scorer,roc_curve,auc,precision_recall_curve
...
class ModelVectors(object):
    def __init__(self,data_dir='../labeldata/',
        ...
        self.train = pickle.load(open(self.data_dir+ 'TrainLabeledData.pkl', "rb" ))
        self.validate = pickle.load(open(self.data_dir+ 'ValidateLabeledData.pkl', "rb" ))
        self.model=FT_gensim.load(self.model_dir+ self.modelName+'.model')
        self.trainLSTM = pickle.load(open(self.data_dir+ 'TrainLabeledDataLSTM.pkl', "rb" ))
        self.validateLSTM = pickle.load(open(self.data_dir+ 'ValidateLabeledDataLSTM.pkl', "rb" ))
        self.testLSTM = pickle.load(open(self.data_dir+ 'TestLabeledDataLSTM.pkl', "rb" ))        
    ...
    def getXYValidate(self, tag='EC'):
        self.validate['pathway_vector'] = self.validate[tag].apply(self.pwyVector)
    ...
    def getXYValidateLSTM(self, tag='EC'):
        self.validate['pathway_vector'] = self.validateLSTM[tag].apply(self.pwyVector)
    ...
    def getAllEnzymes(self):
        self.allData = pickle.load(open(self.data_dir+ 'LabeledData.pkl', "rb" ))
    ...
    def getXYControl(self):
        ...
        self.validate['control_vector'] = self.validate.EC.apply(self.getControl)
...
class BuildClassicalModel(ModelVectors):
    ...
    def spotStrplot(self):
        ...
        self.strplot(self.accuracy,self.title,metricLabel='Exact match accuracy')
