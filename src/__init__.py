...
class ExtractLabeledData(object):
    ...
    def get_classes_dict(self, file="metacyc_classes_all.pkl"): 
        ...
        self.Act=self.get_classes_dict_labels('Activation-Inactivation-Interconversion',classes)
        ...
        self.Mac=self.get_classes_dict_labels('Macromolecule-Modification',classes)
...
class BalanceLabelData(object):
    ...
    def createAllPartialAnnot(self):
        for annotLevel in range(1,4):
            ...
            self.allData[temp] = self.allData.EC.apply(self.applyPartialAnnot,annotLevel=annotLevel)
        return self.allData
